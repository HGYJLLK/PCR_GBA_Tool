...
def template_matching():
    ...
    try:
        # 彩色匹配
        logger.info("彩色匹配...")
        sim_color, button_color = TEMPLATE_CHUNJIAN.match_result(module.device.image)
        ...
        # 亮度匹配
        logger.info("亮度匹配...")
        sim_luma, button_luma = TEMPLATE_CHUNJIAN.match_luma_result(module.device.image)
...
def complete_flow():
    ...
    # 搜索目标
    target_template = TEMPLATE_CHUNJIAN
    similarity_threshold = 0.85
    max_swipes = 20
